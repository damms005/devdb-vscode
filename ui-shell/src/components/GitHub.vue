...
<template>
	<a
		href="https://github.com/damms005/devdb-vscode"
		class="flex items-center rounded bg-white px-2 py-1 text-sm font-semibold text-gray-500 opacity-70 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 hover:text-gray-900 hover:opacity-100 transition"
	>
